...
/**
 *  The text color to use in displaying the string stored in `typingIndicatorMessage`. The default value is a light gray color. Setting this value will hide the typing indicator message bubble and llipsis image.
 */
@property (strong, nonatomic) UIColor *typingIndicatorTextColor;

/**
 *  The font to use in displaying the string stored in `typingIndicatorMessage`. The default value is an italic system font at 11pt. Setting this value will hide the typing indicator message bubble nd ellipsis image.
 */
